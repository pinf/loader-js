...
__loader__.__require__.platform = 'wakanda';
__loader__.memoize('adapter/wakanda', function(__require__, module, exports) {
// ######################################################################
// # /adapter/wakanda.js
// ######################################################################
// Authors:
...
exports.init = function(api)
{
    ...
    if (typeof api.SYSTEM.print == "undefined")
    {
        ...
        {
        	// @see http://doc.wakanda.org/Console/Console-Class/log.301-633845.en.html
            console.log(msg);
        });
    }
