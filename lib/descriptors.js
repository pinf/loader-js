...
Program.prototype.augmentLocator = function(locator)
{
    ...
    if (typeof locator.id != "undefined")
    {
        enforce = true;
        ids.push(locator.id);
        if (typeof this.json.packages[locator.id] != "undefined")
            found = this.json.packages[locator.id];
    }
    // TODO: Check UID with optional version/revision
    ...
    return UTIL.deepMerge(locator, found.locator);
}
