 ...
 */
Sandbox.prototype.packageForId = function(id)
{
    if (!id)
    ...
    var lookupId;
    if (lookupIds.length==0 || (lookupId = Object.keys(this.packages).filter(function(id) { return (lookupIds.indexOf(id)>-1); })).length == 0)
