module.declare(["package2/package2"], function(require, exports, module) {
    ...
    exports.runTests = function() {
        ...
        var ok = true,
            ...
            // We fetch the module by <packageUID>!/<modulePath> as the package is not mapped for this package
            // NOTE: The module ID here is a *path relative to package root* and *not* a simple ID
            options = require("registry/hostname/path/package1/!/lib/main").getOptions();

        if(module.id != options.mainModuleDir + "/package3-dir/!/lib-dir/package3")
            ok = false;

        // Same as above: <packageUID>!/<modulePath>
        if(require.id("registry/hostname/path/package1/!/lib/main") != options.mainModuleDir + "/package1-dir/!/lib/main")
            ok = false;
