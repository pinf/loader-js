...
//        return;
    ...
    function run()
    {
	    API.DEBUG.print("\0magenta(--- http://pinf.org/ ------------------------- http://commonjs.org/ ---");
	    API.DEBUG.print   ("|   \0bold(PINF JavaScript Loader ~ https://github.com/pinf/loader-js/\0)       |");
	    API.DEBUG.print          ("------------------------------- (c) Christoph Dorn --- License: MIT ---\0)");
