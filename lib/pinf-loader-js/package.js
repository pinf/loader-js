...
var Package = exports.Package = function(descriptor)
{
    ...
    {
        if (typeof this.descriptor.json.overlay["pinf:" + API.ENV.platform] != "undefined")
        {
            this.normalizedDescriptor.json = API.UTIL.deepMerge(this.normalizedDescriptor.json, this.descriptor.json.overlay["pinf:" + API.ENV.platform]);
        }
    }
